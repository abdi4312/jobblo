...
router.post('/:listId/contributors', authenticate, listController.addContributors);
router.delete('/:listId/contributors/:userId', authenticate, listController.removeContributor);
router.delete(
