...
export const userTerms = {
  ...
  intro:
    'Disse brukervilkårene ("vilkårene") regulerer din bruk av Jobblo-plattformen, som eies og drives av Jobblo AS, organisasjonsnummer 931684930. Ved å bruke plattformen, godtar du å være bundet av disse vilkårene. Hvis du ikke godtar vilkårene, må du ikke bruke tjenesten.',
  footer:
    'Dette dokumentet er utformet for å være i samsvar med norsk lovgivning og beste praksis.',
  sections: [
    {
      id: 1,
...
• Erstatningsansvar: Under ingen omstendigheter vil Jobblo AS være ansvarlig for tap eller skade som oppstår som følge av bruk av plattformen, med mindre tapet skyldes grov uaktsomhet fra vår side.`,
    },
    {
      ...
      content:
        'Alt innhold på Jobblo, inkludert design, tekst og grafikk, er beskyttet av opphavsrett og annen immaterialrett som tilhører Jobblo AS. Du har ikke lov til å kopiere, endre eller distribuere innhold fra plattformen uten skriftlig samtykke fra Jobblo AS.',
    },
    {
      id: 6,
      title: 'Endringer i vilkårene',
      content:
        'Jobblo AS forbeholder seg retten til å endre disse vilkårene når som helst. Vesentlige endringer vil bli varslet på plattformen eller via e-post. Din fortsatte bruk av tjenesten etter at endringene er publisert, anses som en aksept av de nye vilkårene.',
    },
    {
      id: 7,
      title: 'Kontaktinformasjon',
      content:
        'Har du spørsmål om disse brukervilkårene, kan du kontakte Jobblo AS med organisasjonsnummer 931684930.',
    },
  ] as TermsSection[],
};
