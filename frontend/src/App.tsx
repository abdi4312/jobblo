...
function JobbloPage() {
  ...
  const heroBackgroundStyles: React.CSSProperties = {
    ...
    width: '390px',
    height: '453px',
    padding: '78px 521.25px 78px 101.25px',
    flexDirection: 'column',
    justifyContent: 'center',
    alignItems: 'flex-end',
    gap: '30px',
    backgroundImage: 'url("https://api.builder.io/api/v1/image/assets/TEMP/da64a984fd5e0c9c3a1bf0dafb72d9f55d01db99?width=780")',
    backgroundSize: '100% 189.38%',
    backgroundPosition: '0px -208.019px',
  ...
  const jobbloTitleStyles: React.CSSProperties = {
    color: '#FFF',
    textShadow: '0 4px 4px rgba(0, 0, 0, 0.46)',
    fontSize: '36px',
    fontWeight: '900',
    lineHeight: '115%',
  };

  const sloganContainerStyles: React.CSSProperties = {
    display: 'flex',
    flexDirection: 'column',
    alignItems: 'center',
    gap: '2px',
  ...
  const sloganStyles: React.CSSProperties = {
    width: '314px',
    color: '#FCF9EB',
  ...
  const mapButtonStyles: React.CSSProperties = {
    display: 'flex',
    width: '24px',
    height: '38px',
    flexDirection: 'column',
  ...
  const exploreButtonStyles: React.CSSProperties = {
    display: 'flex',
    height: '28px',
    justifyContent: 'center',
    alignItems: 'center',
  ...
  const postJobButtonStyles: React.CSSProperties = {
    display: 'flex',
    height: '28px',
    justifyContent: 'center',
    alignItems: 'center',
  ...
  const orangeBarStyles: React.CSSProperties = {
    width: '390px',
    height: '46px',
  ...
  const campaignTextStyles: React.CSSProperties = {
    color: '#FFF',
    fontSize: '20px',
    fontWeight: '800',
    lineHeight: '120%',
  ...
  const whatIsJobbloSectionStyles: React.CSSProperties = {
    width: '351px',
    height: '346px',
    position: 'absolute',
    left: '24px',
  ...
  const whatIsJobbloContentStyles: React.CSSProperties = {
    width: '249px',
    height: '346px',
    position: 'absolute',
    left: '0px',
  ...
  const whatIsJobbloTitleStyles: React.CSSProperties = {
    display: 'inline-flex',
    paddingBottom: '0.132px',
    justifyContent: 'flex-end',
    alignItems: 'flex-end',
    gap: '-0.643px',
    position: 'absolute',
  ...
  const whatIsTitleStyles: React.CSSProperties = {
    width: '74px',
    height: '29px',
    color: '#111D15',
    fontSize: '24px',
  ...
  const jobbloLogoStyles: React.CSSProperties = {
    width: '127px',
    height: '47px',
    position: 'absolute',
    left: '73px',
  ...
  const howItWorksSectionStyles: React.CSSProperties = {
    width: '391px',
    height: '376px',
    background: '#142F18',
    position: 'absolute',
  ...
  const howItWorksTitleStyles: React.CSSProperties = {
    width: '232px',
    height: '28px',
    color: '#FFF',
    fontSize: '24px',
  ...
  const learnMoreButtonStyles: React.CSSProperties = {
    display: 'flex',
    width: '89px',
    height: '28px',
    ...
    borderRadius: '150px',
    background: '#FCF9EB',
    boxShadow: '0 0 3.75px 0 rgba(0, 0, 0, 0.10)',
    position: 'absolute',
    left: '14px',
    top: '75px',
    border: 'none',
  ...
  const learnMoreTextStyles: React.CSSProperties = {
    width: '56.25px',
    color: '#111D15',
    textAlign: 'center',
    fontSize: '14px',
  ...
  const categoriesTitleStyles: React.CSSProperties = {
    color: '#000',
    fontSize: '20px',
    fontWeight: '600',
    lineHeight: '120%',
  ...
  const subscriptionSectionStyles: React.CSSProperties = {
    width: '322px',
    height: '486px',
    position: 'absolute',
    left: '34px',
  ...
  const subscriptionBackgroundStyles: React.CSSProperties = {
    width: '322px',
    height: '168px',
    borderRadius: '10px',
    backgroundImage: 'url("https://api.builder.io/api/v1/image/assets/TEMP/82d02f5d2fe9482d8f6c8f63f5c9d7cee64ca4df?width=644")',
  ...
  const subscriptionTitleStyles: React.CSSProperties = {
    width: '295px',
    height: '47px',
    color: '#FFF',
    textAlign: 'center',
  ...
  const toggleButtonsStyles: React.CSSProperties = {
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
    gap: '12px',
  ...
  const monthlyButtonStyles: React.CSSProperties = {
    display: 'flex',
    padding: '5.25px 16.5px',
    justifyContent: 'center',
    alignItems: 'center',
    gap: '7.5px',
    borderRadius: '150px',
    background: isMonthly ? '#E08835' : '#FCF9EB',
    boxShadow: isMonthly ? '0 0 7.5px 0 rgba(0, 0, 0, 0.10)' : '0 0 3.75px 0 rgba(0, 0, 0, 0.10)',
    color: isMonthly ? '#FCF9EB' : '#111D15',
    fontSize: '16px',
    fontWeight: '500',
    lineHeight: '120%',
    border: 'none',
  ...
  const yearlyButtonStyles: React.CSSProperties = {
    display: 'flex',
    padding: '5.25px 16.5px',
    justifyContent: 'center',
    alignItems: 'center',
  ...
  const subscriptionCardStyles: React.CSSProperties = {
    width: '212px',
    height: '354px',
    position: 'absolute',
    left: '56px',
  ...
  const cardBackgroundStyles: React.CSSProperties = {
    width: '212px',
    height: '309px',
    background: '#111D15',
    borderRadius: '18px',
  ...
  const testimonialsBackgroundStyles: React.CSSProperties = {
    width: '389px',
    height: '296px',
    background: '#FBECD5',
    position: 'absolute',
  ...
  const testimonialsBottomStyles: React.CSSProperties = {
    width: '408px',
    height: '178px',
    background: '#111D15',
    position: 'absolute',
    ...
    <div style={pageStyles}>
      ...
      <div style={headerStyles}>
        ...
        <div style={navStyles}>
          ...
          <button style={minSideButtonStyles}>
            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" style={{ marginRight: '3px' }}>
      ...
      <div style={heroStyles}>
        ...
        <div style={heroContentStyles}>
          <h1 style={jobbloTitleStyles}>Jobblo AS</h1>
          <div style={sloganContainerStyles}>
            <div style={sloganStyles}>
              <span style={{ fontSize: '20px' }}>Små jobber. </span>
              <span style={{ fontSize: '24px' }}>Store muligheter</span>
      ...
      <div style={searchSectionStyles}>
        <div style={mapButtonStyles}>
          ...
          <div style={{ color: '#FFF', fontSize: '12px', fontWeight: '400', marginTop: '4px' }}>Kart</div>
        </div>
      ...
      <div style={actionButtonsStyles}>
        <button style={exploreButtonStyles}>Utforsk Jobblo</button>
        <button style={postJobButtonStyles}>Legg ut annonse!</button>
      </div>

      {/* Orange Bar */}
      <div style={orangeBarStyles}></div>

      {/* Campaign Text */}
      <div style={campaignTextStyles}>Obs! Kampanje motta tilbud :)</div>

      {/* Divider Line */}
      <div style={dividerLineStyles}></div>

      {/* What is Jobblo Section */}
      <div style={whatIsJobbloSectionStyles}>
        <div style={whatIsJobbloContentStyles}>
          <div style={whatIsJobbloTitleStyles}>
            <div style={whatIsTitleStyles}>Hva er</div>
            <img 
              src="https://api.builder.io/api/v1/image/assets/TEMP/38b5582872e8017a60c396f9ef20d95a9725eaf1?width=254" 
              alt="Jobblo logo" 
              style={jobbloLogoStyles}
            />
          </div>
          <div style={descriptionTextStyles}>
            <span style={{ color: 'rgba(208,122,42,1)' }}>
        ...
        <div style={imageContainerStyles}>
          ...
          <img 
            ...
            style={{
              ...
              left: '9px',
              top: '30px',
              filter: 'drop-shadow(12px 4px 4px rgba(0, 0, 0, 0.25))',
            }}
          />
        </div>
      </div>
      ...
      <div style={howItWorksSectionStyles}>
        <div style={howItWorksTitleStyles}>Slik fungerer jobblo</div>
        <button style={learnMoreButtonStyles}>
          <span style={learnMoreTextStyles}>Les mer</span>
        </button>
      ...
      {/* Categories Title */}
      <div style={categoriesTitleStyles}>Kategorier</div>

      {/* Category Grid */}
      <div style={categoryGridStyles}>
        {/* Hage */}
        <div style={categoryItemStyles}>
          <svg width="31" height="31" viewBox="0 0 32 32" fill="none" style={{ marginBottom: '8px' }}>
          ...
          <div style={categoryLabelStyles}>Hage</div>
        </div>
        ...
        <div style={categoryItemStyles}>
          ...
          <div style={categoryLabelStyles}>Snekk</div>
        </div>
        ...
        <div style={categoryItemStyles}>
          ...
          <div style={categoryLabelStyles}>Vask</div>
        </div>
        ...
        <div style={categoryItemStyles}>
          ...
          <div style={categoryLabelStyles}>Transport</div>
        </div>

        {/* Elektriker */}
        <div style={categoryItemStyles}>
          <svg width="15" height="29" viewBox="0 0 15 30" fill="none" style={{ marginBottom: '8px' }}>
            <path d="M14.7273 11.9659H7.36364V0L0 17.4886H7.36364V29.4545L14.7273 11.9659Z" fill="white"/>
          </svg>
          <div style={categoryLabelStyles}>Elektriker</div>
        </div>
      ...
      <div style={subscriptionSectionStyles}>
        <div style={subscriptionBackgroundStyles}></div>
        <div style={subscriptionTitleStyles}>
          Abonner slik at oppdragene dine blir gjort effektivt.
        </div>
        <div style={toggleContainerStyles}>
          <div style={toggleButtonsStyles}>
            <button 
              style={monthlyButtonStyles}
              onClick={() => setIsMonthly(true)}
            >
              Månedlig
            </button>
            <button 
              style={yearlyButtonStyles}
        ...
        <div style={subscriptionCardStyles}>
          <div style={cardBackgroundStyles}></div>
      ...
      <div style={testimonialsSectionStyles}>
        <div style={testimonialsBackgroundStyles}>
          <div style={{
            width: '375px',
            color: '#111D15',
            fontSize: '11px',
        ...
        <div style={testimonialsBottomStyles}></div>
      </div>
