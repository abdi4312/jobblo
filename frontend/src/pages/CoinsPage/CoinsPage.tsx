...
export default function CoinsPage() {
  ...
  useEffect(() => {
    ...
    async function getRewards() {
      const rewards: Reward[] = await getJobbloShop();
      setRewards(rewards);
    }
  ...
  const handleRedeem = async (rewardId: number, coinCost: number) => {
    if (userCoins >= coinCost) {
      ...
      await buyItem(rewardId.toString());
        ...
        <div className={styles.coinIcon}>
          ...
          >
            <g filter="url(#filter0_f_866_7805)">
              <path
                d="M30.5 52C42.6503 52 52.5 42.1503 52.5 30C52.5 17.8497 42.6503 8 30.5 8C18.3497 8 8.5 17.8497 8.5 30C8.5 42.1503 18.3497 52 30.5 52Z"
            ...
            <path
              d="M30.5 48C40.4411 48 48.5 39.9411 48.5 30C48.5 20.0589 40.4411 12 30.5 12C20.5589 12 12.5 20.0589 12.5 30C12.5 39.9411 20.5589 48 30.5 48Z"
      ...
      <div className={styles.rewardsGrid}>
        {rewards.map((reward) => (
          <div key={reward._id} className={styles.rewardCard}>
            ...
            <button
              onClick={() => handleRedeem(reward._id, reward.coins)}
