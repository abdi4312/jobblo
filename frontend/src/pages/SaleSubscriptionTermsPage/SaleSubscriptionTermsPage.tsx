export default function JobbloTerms() {
  const sections = [
    ...
    },
    {
      ...
      content: 'Abonnement fornyes automatisk med mindre det sies opp innen oppsigelsesfristen.',
    },
    {
      id: 8,
      title: 'OPPSIGELSE',
    ...
    },
    {
      ...
      content: 'Jobblo er kun ansvarlig for grov uaktsomhet.\n Indirekte tap erstattes ikke.',
    },
    {
      id: 15,
      title: 'ENDRINGER',
      content: 'Jobblo kan endre vilkårene. Endringer publiseres på nettstedet.',
    },
    {
      id: 16,
      ...
      <div style={styles.content}>
        ...
        <div style={styles.introText}>
          <p style={styles.paragraph}>
            Dette dokumentet utgjør fullstendige, bindende og juridisk gyldige salgs-, bruks- og
            abonnementsvilkår for bruk av Jobblo-plattformen.
          </p>
        </div>
        ...
        <div style={styles.footer}>
          <p style={styles.footerText}>
            ...
            og etterligner profesjonelle markedsplasser som Mittanbud i struktur og presisjon.
          </p>
        </div>
      </div>
    </div>
