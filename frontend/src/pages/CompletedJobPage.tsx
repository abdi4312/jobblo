                        ...
                        >
                          ...
                          {msg.attachments && msg.attachments.length > 0 && (
                            <div className="mt-2 space-y-2">
                              {msg.attachments.map((attachment: string, attIndex: number) => (
                                <a
                                  key={attIndex}
                                  href={attachment}
                                  target="_blank"
                                ...
                                >
                                  <FileText size={16} />
                                  <span className="truncate">Vedlegg {attIndex + 1}</span>
                                </a>
                              ))}
                            </div>
                          )}
                          {msg.createdAt && (
                            <p
                              className={`text-xs opacity-70 text-right mt-1 ${
                                msg.senderId === user?._id ? 'text-white' : 'text-gray-500'
                              }`}
                            >
              ...
              <div className="space-y-4">
                {payment ? (
                  <div className="bg-gray-50 rounded-lg p-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-lg">{payment.amount.toLocaleString()} kr</p>
                      </div>
                    </div>
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">Ingen betalingsinformasjon tilgjengelig</p>
                  </div>
                )}
              </div>
            )}
            ...
            {activeTab === 'images' && (
              <div className="space-y-8">
                ...
                <div>
                  ...
                  {order && order.beforeImages && order.beforeImages.length > 0 ? (
                    ...
                    <div className="text-center py-12 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-gray-500">Ingen "før"-bilder lastet opp</p>
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {order && order.afterImages && order.afterImages.length > 0 ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div className="text-center py-12 bg-gray-50 rounded-lg">
                      <FileText size={48} className="mx-auto text-gray-300 mb-4" />
                      <p className="text-gray-500">Ingen "etter"-bilder lastet opp</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-4">
                {order && order.attachments && order.attachments.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {order.attachments.map((attachment: string, index: number) => (
                      <a
                        key={index}
                        href={attachment}
                        target="_blank"
