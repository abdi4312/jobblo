      ...
      <div style={styles.content}>
        ...
        <div style={styles.introText}>
          <p style={styles.paragraph}>
            Disse brukervilkårene ("vilkårene") regulerer din bruk av Jobblo-plattformen, som eies
            og drives av Jobblo AS, organisasjonsnummer 931684930. Ved å bruke plattformen, godtar
            du å være bundet av disse vilkårene. Hvis du ikke godtar vilkårene, må du ikke bruke
            tjenesten.
          </p>
        </div>
