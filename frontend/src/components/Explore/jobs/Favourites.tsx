      ...
      <div className="w-full max-w-300 mx-auto px-4">
        ...
        <div className="flex justify-between items-end mb-8">
          ...
          <div className="lg:flex gap-3 hidden">
            <button
              id="fav-prev"
              className="w-11 h-11 rounded-full border border-[#0A0A0A] flex items-center
            ...
            <button
              id="fav-next"
              className="w-11 h-11 rounded-full border border-[#0A0A0A] flex items-center justify-center
