    ...
    <>
      <div className="flex-1 bg-[linear-gradient(180deg,#F5F5F5_0%,#FFFFFF_100%)] p-8 rounded-[24px] shadow-sm">
        ...
        <form className="space-y-4 p-0!">
          ...
          <button
            type="submit"
            className="w-full bg-custom-green hover:bg-[#1E5230] text-white py-4 text-[16px] rounded-xl font-semibold flex items-center justify-center gap-2 transition-colors mt-4"
          >
            <Send size={18} />
            Send melding
          </button>
