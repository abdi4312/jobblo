    ...
    <div className="bg-white pt-16 px-4 font-sans">
      <div className="max-w-[1151px] mx-auto">
        ...
        <div className="flex flex-col gap-4 text-center mb-16">
          <h2 className="text-[23px] sm:text-[28px] md:text-[32px] font-bold text-custom-black">
            Trenger du mer hjelp?
          </h2>
          <p className="text-[#0A0A0A9E] text-[16px] font-normal">
      ...
      <button className="fixed bottom-8 right-8 bg-custom-green text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform">
