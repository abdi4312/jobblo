...
const JobProvider: React.FC<JobProviderProps> = ({ job }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      {/* Lønn Section */}
      <div className="flex flex-col max-h-33.75 text-custom-black gap-2 rounded-[14px] bg-white shadow-[0px_2px_4px_0px_rgba(0,0,0,0.08)] p-6">
      ...
      >
        <p className="text-base font-bold text-custom-black">Om oppdragsgiveren</p>
