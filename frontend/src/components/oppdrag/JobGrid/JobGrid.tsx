...
const JobGrid: React.FC = () => {
  const jobs = [
    ...
    },
    {
      id: 3,
      image:
        'https://api.builder.io/api/v1/image/assets/TEMP/4dcea95cbb92944ad1f5c8a8a8c0a199ac1a638c?width=346',
      title: 'Maling av stue',
      category: 'Male',
      equipment: 'Utstyr fri',
      location: 'Gate 12 , Bærum',
    ...
    },
    {
      id: 4,
      image:
        'https://api.builder.io/api/v1/image/assets/TEMP/fabc6c79d1bc295e56a2b2e4f27520c3554fd155?width=346',
      title: 'Maling av stue',
      category: 'Male',
      equipment: 'Utstyr fri',
      location: 'Gate 12 , Bærum',
