...
import { ExternalLink, CreditCard, Tag, DollarSign, RotateCcw } from 'lucide-react';
            ...
            return (
              <tr key={tx._id} className="group hover:bg-slate-50/50 transition-all">
                ...
                <td className="py-6 px-4 text-center">
                  ...
                  >
                    {tx.refunded ? <RotateCcw size={12} /> : status.icon} {status.label}
                  </span>
                </td>
                ...
                <td className="py-6 px-4 text-right">
                  ...
                  >
                    REF: {tx.stripeSessionId?.slice(-8).toUpperCase()} <ExternalLink size={10} />
                  </a>
                </td>
