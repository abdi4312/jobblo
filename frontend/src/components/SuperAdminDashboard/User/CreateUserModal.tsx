      ...
      <div className="bg-white w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl animate-in zoom-in duration-300">
        ...
        <form onSubmit={handleCreateUser} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#2d4a3e] text-white py-4 rounded-2xl font-bold text-sm shadow-lg hover:shadow-xl transition-all active:scale-95 disabled:opacity-50 mt-4"
          >
