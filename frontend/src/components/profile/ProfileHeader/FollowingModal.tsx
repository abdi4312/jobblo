    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-[420px] relative z-10 overflow-hidden animate-in zoom-in-95 fade-in duration-200">
        <div className="p-6">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-[14px] text-gray-500 font-medium leading-snug">
                Get notification when {userName} posts a new job
              </p>
            </div>
            <button
            ...
            >
              <div
                className={`absolute top-1 w-6 h-6 bg-white rounded-full transition-all duration-300 shadow-sm ${isNotifyEnabled ? "left-7" : "left-1"}`}
              />
            </button>
          </div>
          ...
          >
            {isPending ? "Unfollowing..." : `Unfollow @${userName}`}
          </button>
        </div>
      </div>
    </div>
