...
export const ProfileField = ({
  ...
  return (
    <div className="bg-[#FFFFFF1A] rounded-xl p-4 mb-3 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 shadow-sm">
      <span className="font-medium text-[16px] md:text-[20px] leading-[100%] text-custom-black min-w-[120px]">
        {label}
      </span>
      ...
      {isEditing ? (
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-all flex items-center gap-1 ${
                isChanged
                  ? "bg-custom-green text-white hover:bg-[#153014] cursor-pointer"
        ...
        <div className="flex items-center justify-between sm:justify-end w-full sm:flex-1">
          ...
          <button
            ...
            className="text-custom-black hover:text-custom-green transition-colors p-1"
          >
            <Pencil size={18} />
          </button>
        </div>
