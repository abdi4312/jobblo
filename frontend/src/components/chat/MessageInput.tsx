    ...
    <div className="p-6 bg-white border-t border-[#F8F9FA] flex items-center gap-4">
      ...
      <div className="flex-1 relative flex items-center">
        <input
          ...
          className="w-full bg-[#F8F9FA] border-none rounded-full py-3.5 px-6 text-[15px] text-[#212529] placeholder-[#ADB5BD] focus:ring-2 focus:ring-custom-green-light outline-none transition-all"
          disabled={sending}
        />
      </div>
