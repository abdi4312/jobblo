...
export function CTABand() {
  ...
  return (
    <div className="bg-[#1a3a1a] rounded-[20px] p-12 flex flex-col md:flex-row items-center justify-between mx-12 mb-15 max-w-[1100px] lg:mx-auto">
      <div className="text-center md:text-left mb-6 md:mb-0">
        <h2 className="text-[26px] font-normal text-white mb-1.5 leading-tight">
          Klar til å komme<br />i <em className="text-[#4ade80] not-italic">gang?</em>
        </h2>
        <p className="text-[13px] text-white/60">Gratis å registrere seg – ingen abonnement nødvendig</p>
      </div>
      <div className="flex gap-2.5">
        ...
        <button 
          onClick={() => navigate("/legg-ut-oppdrag")}
