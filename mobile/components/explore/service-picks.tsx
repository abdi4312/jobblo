...
const MOCK_SERVICES = [
  {
    ...
    image:
      'https://images.unsplash.com/photo-1600518464441-9154a4dea21b?q=80&w=1000&auto=format&fit=crop',
  },
  {
    id: '2',
    title: 'Home & Office Cleaning',
    image:
      'https://static.tise.com/69c9054c764957bcb3e34af7/image0/8ad5be19-03a9-4117-a0bf-4df83fb1a665/sort-barbour-jakke',
  },
  {
    id: '3',
  ...
  const renderCard = (item: (typeof MOCK_SERVICES)[0], isBottom = false) => (
    <TouchableOpacity key={item.id} className={`${isBottom ? '' : 'mb-4'}`}>
      ...
      >
        ...
        <Text className="text-white text-[16px] font-medium text-center">{item.title}</Text>
      </ImageBackground>
    </TouchableOpacity>
  );
  ...
  return (
    <View className="mb-10">
      ...
      <View className="px-4 mb-6">
        ...
        <Text className="text-[#9E9E9E] text-[12px] font-light mt-2">
          Popular services tailored for your needs
        </Text>
      </View>
