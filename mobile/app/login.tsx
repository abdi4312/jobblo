...
export default function LoginScreen() {
    ...
    return (
        <ImageBackground
            source={{ uri: 'https://images.unsplash.com/photo-1581244276891-8309cfbb304c?q=80&w=2070&auto=format&fit=crop' }} // Placeholder workshop image
            className="flex-1"
        >
                                    ...
                                    {(field) => (
                                        <View>
                                            ...
                                            <TouchableOpacity className="mt-2 items-end">
                                                <Text className="text-white text-xs font-medium">Glemt passord? Klikk her</Text>
                                            </TouchableOpacity>
                                        </View>
                                    )}
                                </Field>
